...
for batch_size in "${batch_sizes[@]}"; do
    for value_size in "${value_sizes[@]}"; do
        ...
        # 使用perf进行性能分析
        perf record -g -F 99 ../build_debug/bin/get_put_hashed_key -b $batch_size -v $value_size -k $key_size -n $n_test -d $data_path -i $index_path -r $result_path
        ...
        # 生成性能报告
        perf report --stdio > results/profiling/perf_report_${batch_size}_${value_size}.txt
